      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center text-northstar-blue">تسجيل الدخول</CardTitle>
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link to="/forgot-password" className="text-sm text-northstar-gold hover:text-northstar-gold/80">
                  نسيت كلمة المرور؟
                </Link>
              </div>
              ...
              <Button 
                type="submit" 
                className="w-full bg-northstar-blue hover:bg-northstar-blue/90 text-white"
              >
                تسجيل الدخول
              </Button>
            </form>
            ...
            <div className="text-center">
              ...
              <Link to="/signup" className="text-northstar-gold hover:text-northstar-gold/80 font-medium">
                إنشاء حساب جديد
              </Link>
            </div>
          </CardContent>
